...
def build(component: str, branch: str, local: bool, remote: bool, container: bool):
    ...
    if (build_type == "LOCAL"):
        ...
        build_command = f"apptainer exec --bind /sdf/sw/:/sdf/sw/ {build_img} python /build/local_build.py {manifest_data} {user_src_repo} {request.component.name} {request.component.branch_name}"
