...
def build(component: str, branch: str, local: bool, remote: bool, container: bool):
    ...
    if (build_type == "LOCAL"):
        ...
        # PATRICK - left off here, it looks to be working when you enter the command manually, 
        # but the main issue is you cant get the single quotes around the json string. 
        # make a python standalone script and play with it till you get the single quotes right
